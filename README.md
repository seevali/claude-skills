...
| [mission-command](mission-command/) | Runs a scarce flagship model as the conductor of a cheap-model fleet: vision-first autonomy, per-agent model/effort pinning, disk-portable protocols, and gated autonomy, with a cost ledger against the shared pool — weeks of verified work in days. |
